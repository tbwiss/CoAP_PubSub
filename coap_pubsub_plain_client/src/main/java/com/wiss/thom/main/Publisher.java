...
public class Publisher {
    ...
    public Publisher(MeasurementWriter writer, String hostIP) {
        this.writer = writer;
    ...
    public void publishData() {
        ...
        //System.out.println("ExamplePublishClient: will publish following content '" + randomContent + "'");
        CoapResponse respOne = client.publish("testg", MediaTypeRegistry.TEXT_PLAIN);
