...
public class CFTestServer {
    ...
    private static final Logger LOG = Logger.getLogger(CFTestServer.class.getName());
    ...
    public CFTestServer(String ipAddress) {
        ...
        try {
            ...
            DtlsConnectorConfig.Builder builder = new DtlsConnectorConfig.Builder(new InetSocketAddress(ipAddress, DEFAULT_PORT));
